...
python source\qwen_supermix_pipeline.py `
  ...
  --output_dir artifacts\qwen_supermix_enhanced_v5_quality `
  --init_adapter_dir artifacts\qwen_supermix_enhanced_v4_quick_quality\adapter `
  --max_records 420 `
  --eval_size 32 `
  --max_length 256 `
  --batch_size 1 `
  ...
  --supermix_distill_ratio 0.50 `
  --supermix_distill_max 240 `
  --seed 42 `
  --device cpu `
  --skip_benchmark
