...
python source\qwen_supermix_pipeline.py `
  ...
  --output_dir artifacts\qwen_supermix_enhanced_v4_quick_quality `
  --init_adapter_dir artifacts\qwen_supermix_enhanced_v3_2026_02_27_offline\adapter `
  --max_records 320 `
  --eval_size 32 `
  --max_length 256 `
  --batch_size 1 `
