...
def smoke_test_training_monitor_parsing():
    sample_lines = [
        ...
        "[distill] config: target=5880 ratio=0.140 max_seconds=12000.0 best_of=3 min_gain=0.180",
        ...
        "[pref] objective schedule: beta=1.9000->3.6000 margin=0.0000->0.0000 ipo_target=0.2632->0.1389 label_smoothing=0.000 xpo_clip=0.000 hardness_gamma=1.150 wpo_alpha=0.350 robust_alpha=0.300 robust_eta=0.080 anchor_weight=0.0000",
