param(
  ...
  [string]$OutputDir = "artifacts\qwen_supermix_enhanced_v23_larger_reasoner",
  [string]$Device = "auto"
)
...
python -u source\qwen_supermix_pipeline.py `
  ...
  --sft_quality_anchor_boost 1.12 `
  --sft_coding_boost 1.20 `
  --sft_events_boost 1.08 `
  --sft_reasoning_boost 1.18 `
  ...
  --sft_source_balance_strength 0.64 `
  --sft_source_balance_max_scale 1.90 `
  --preference_objective simpo `
  --preference_steps 100 `
  --preference_pairs 2200 `
  --preference_candidate_count 6 `
  --preference_reject_similarity_min 0.16 `
  --preference_beta 2.8 `
  --preference_margin 0.24 `
  --preference_sft_weight 0.34 `
  ...
  --preference_max_pairs_per_source 280 `
  --preference_mining_mode auto `
  --preference_mining_progress_every 30 `
  --preference_mining_max_seconds 3600 `
  --preference_mining_max_attempt_factor 18 `
  --preference_coding_focus_boost 1.22 `
  --preference_reasoning_focus_boost 1.18 `
  --preference_counterfactual_rejects_per_prompt 3 `
  --preference_lr 1.5e-5 `
  --preference_lr_schedule cosine `
  --preference_warmup_steps 14 `
  --preference_min_lr_ratio 0.32 `
  --preference_max_grad_norm 0.9 `
  --preference_max_new_tokens 96 `
  --preference_prompt_max_tokens 320 `
  --supermix_distill_ratio 0.12 `
  --supermix_distill_max 600 `
