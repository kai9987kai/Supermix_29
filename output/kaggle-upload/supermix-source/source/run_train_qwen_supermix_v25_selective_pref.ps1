param(
  ...
  [string]$OutputDir = "artifacts\qwen_supermix_enhanced_v25_selective_pref",
  [string]$Device = "auto"
)
...
python -u source\qwen_supermix_pipeline.py `
  ...
  --preference_max_pairs_per_source 340 `
