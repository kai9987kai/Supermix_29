param(
  ...
  [string]$OutputDir = "artifacts\qwen_supermix_enhanced_v24_adaptive_orpo_trust",
  [string]$Device = "auto"
)
...
python -u source\qwen_supermix_pipeline.py `
  ...
  --sft_coding_boost 1.22 `
  --sft_events_boost 1.08 `
  --sft_reasoning_boost 1.20 `
  --sft_prompt_skill_boost 1.12 `
